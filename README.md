...
<h1 align="center">
<img alt="Logo da aplicação/Seu nome é Be the Hero" title="Be the Hero Logo" src="https://github.com/JsnEvt/BeTheHero/blob/main/fotos/logo.png">
  <h1 align="center">
...
<p align="center">
  <b>Aplicação WEB</b>
  <br>
    <img alt="Página de login"  title="Página de login" src="fotos/logon.png">
    <img alt="Cadastro de ONG"  title="Cadastro"src="fotos/cadastro_ong.png">
    <img alt="Casos"  title="Casos"src="fotos/casos.png">
</p>
<p align="center">
  <b>Apliação Mobile</b>
  <br>
    <img alt="Casos mobile" " title="Página de casos" src="fotos/causa_meios_de_contato.png">
     <img alt="Enviar e-mail" title="Página de enviar e-mail" src="fotos/email.png">
</p>
